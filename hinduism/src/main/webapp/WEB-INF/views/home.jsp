					...
					<div class="owl-carousel active-post-carusel">
						<div class="post-box mb-30">
							<div class="d-flex">
								<div>
									<a href="#">
										<img src="/myhinduism/resources/img/author/a1.png" alt="">
									</a>
								</div>
								<div class="post-meta">
									<div class="meta-head">
			...
			<div class="row">
				<div class="col-lg-8 post-list">
					...
					<section class="post-area">
						<div class="single-post-item">
							<figure>
								<img class="post-img img-fluid" src="/myhinduism/resources/img/posts/p1.png" alt="">
							</figure>
							<h3>
						...
						<div class="single-post-item">
							<figure>
								<img class="post-img img-fluid" src="/myhinduism/resources/img/posts/p2.png" alt="">
							</figure>
							<h3>
						...
						<div class="single-post-item">
							<figure>
								<img class="post-img img-fluid" src="/myhinduism/resources/img/posts/p3.png" alt="">
							</figure>
							<h3>
						...
						<div class="single-post-item">
							<figure>
								<img class="post-img img-fluid" src="/myhinduism/resources/img/posts/p4.png" alt="">
							</figure>
							<h3>
						...
						<div class="single-post-item">
							<figure>
								<img class="post-img img-fluid" src="/myhinduism/resources/img/posts/p5.png" alt="">
							</figure>
							<h3>
				...
				<div class="col-lg-4 sidebar">
					...
					<div class="single-widget protfolio-widget">
						<img class="img-fluid" src="/myhinduism/resources/img/blog/user2.png" alt="">
						<a href="#">
						...
						<div class="blog-list ">
							<div class="single-popular-post d-flex flex-row">
								<div class="popular-thumb">
									<img class="img-fluid" src="/myhinduism/resources/img/blog/r1.jpg" alt="">
								</div>
							...
							<div class="single-popular-post d-flex flex-row">
								<div class="popular-thumb">
									<img class="img-fluid" src="/myhinduism/resources/img/blog/r2.jpg" alt="">
								</div>
								<div class="popular-details">
									<a href="blog-details.html">
							...
							<div class="single-popular-post d-flex flex-row">
								<div class="popular-thumb">
									<img class="img-fluid" src="/myhinduism/resources/img/blog/r3.jpg" alt="">
								</div>
								<div class="popular-details">
									<a href="blog-details.html">
							...
							<div class="single-popular-post d-flex flex-row">
								<div class="popular-thumb">
									<img class="img-fluid" src="/myhinduism/resources/img/blog/r4.jpg" alt="">
								</div>
								<div class="popular-details">
									<a href="blog-details.html">
